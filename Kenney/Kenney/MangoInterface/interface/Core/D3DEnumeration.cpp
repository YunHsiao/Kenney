...
UINT MANGOAlphaChannelBits( D3DFORMAT fmt );
...
HRESULT CD3DEnumeration::Enumerate( IDirect3D9* pD3D,
								   LPMANGOCALLBACKISDEVICEACCEPTABLE IsDeviceAcceptableFunc,
								   void* pIsDeviceAcceptableFuncUserContext )
{
	if( pD3D == NULL )
	{
		pD3D = MANGOGetD3DObject();
		if( pD3D == NULL )
			return MANGOERR_NODIRECT3D;
	}
	...
	HRESULT hr;
	ClearAdapterInfoList();
	CMangoArray<D3DFORMAT> adapterFormatList;
...
//--------------------------------------------------------------------------------------
HRESULT CD3DEnumeration::EnumerateDevices( CD3DEnumAdapterInfo* pAdapterInfo, CMangoArray<D3DFORMAT>* pAdapterFormatList )
{
	HRESULT hr;
	...
	for( UINT iDeviceType = 0; iDeviceType < devTypeArrayCount; iDeviceType++ )
	{
		...
		pp.Windowed         = TRUE;
		pp.hDeviceWindow    = MANGOGetHWNDFocus();
		IDirect3DDevice9 *pDevice = NULL;
		if( FAILED( hr = m_pD3D->CreateDevice( pAdapterInfo->AdapterOrdinal, pDeviceInfo->DeviceType, MANGOGetHWNDFocus(),
...
//--------------------------------------------------------------------------------------
HRESULT CD3DEnumeration::EnumerateDeviceCombos( CD3DEnumAdapterInfo* pAdapterInfo, CD3DEnumDeviceInfo* pDeviceInfo, CMangoArray<D3DFORMAT>* pAdapterFormatList )
{
...
//       CD3DEnumAdapterInfo* 
//--------------------------------------------------------------------------------------
CMangoArray<CD3DEnumAdapterInfo*>* CD3DEnumeration::GetAdapterInfoList()
{
...
//--------------------------------------------------------------------------------------
CMangoArray<D3DFORMAT>* CD3DEnumeration::GetPossibleDepthStencilFormatList() 
{
...
//--------------------------------------------------------------------------------------
CMangoArray<D3DMULTISAMPLE_TYPE>* CD3DEnumeration::GetPossibleMultisampleTypeList()
{
...
//--------------------------------------------------------------------------------------
CMangoArray<UINT>* CD3DEnumeration::GetPossiblePresentIntervalList()
{
